...
export function JamTopicStudio() {
  ...
  return (
    <div className="my-8 overflow-hidden rounded-3xl border border-sky-200/90 bg-linear-to-b from-white via-sky-50/20 to-white shadow-md">
      ...
      <div className="border-b border-sky-100 bg-linear-to-r from-sky-600 via-teal-600 to-sky-700 px-6 py-5 text-white">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl bg-white/15 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-xs hover:bg-white/25 active:scale-95 transition"
          >
      ...
      {/* Category Tabs */}
      <div className="flex overflow-x-auto border-b border-slate-100 bg-slate-50/60 px-6 py-2.5 gap-2 scrollbar-none">
        {categories.map((cat) => (
          <button
            key={cat}
            onClick={() => {
