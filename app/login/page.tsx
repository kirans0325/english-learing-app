      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-200/90 bg-white p-8 shadow-sm">
        <div className="text-center">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Sign in to track your English learning journey and saved words
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100 text-xs text-slate-600">
          ...
          <p>
            Admin email: <code className="font-mono text-emerald-800">admin@englishflow.com</code>
          </p>
          <p>
            Password: <code className="font-mono text-emerald-800">admin123</code>
          </p>
        </div>
